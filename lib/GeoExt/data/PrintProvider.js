...
GeoExt.data.PrintProvider = Ext.extend(Ext.util.Observable, {
     ...
     *  ``Ext.data.JsonStore`` read-only. A store representing the
     * output formats available.
     *  
     *  Fields of records in this store:
     *  
     *  * name - ``String`` the format extension
     *  * value - ``String`` the format extension
     */
    outputFormats: null,
     ...
     *  ``Ext.data.Record`` the record for the currently used output format.
     *  Read-only, use ``setOutputFormat`` to set the value.
     */
    outputFormat: null,
    ...
    constructor: function(config) {
        ...
        this.addEvents(
             ...
             *  * printProvider - :class:`GeoExt.data.PrintProvider` this
             *    PrintProvider
             *  * outputFormat - ``Ext.data.Record`` the new outputFormat record
             */
            "outputformatchange",
        ...
        this.outputFormats = new Ext.data.JsonStore({
            root: "outputFormats",
            fields: ["name", {name: "value", mapping: "name", type: "string"}]
        });
     ...
     *  :param format: ``Ext.data.Record`` the outputFormat record.
     *  
     *  Sets the outputFormat for this printProvider.
     */
    setOutputFormat: function(format) {
        this.outputFormat = format;
        this.fireEvent("outputformatchange", this, format);
    },
    ...
    print: function(map, pages, options) {
        ...
        var jsonData = Ext.apply({
            ...
            outputFormat: this.outputFormat.get("value")
        }, this.customParams);
    ...
    loadStores: function() {
        ...
        // Assume pdf if no outputFormats found in capabilities (older provider compatibility)
        this.capabilities.outputFormats = this.capabilities.outputFormats || [{"name":"pdf"}];
